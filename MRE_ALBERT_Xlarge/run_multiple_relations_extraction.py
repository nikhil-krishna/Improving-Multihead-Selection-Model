...
flags.DEFINE_string(
    "bert_config_file", 'pretrained_model/chinese_L-12_H-768_A-12/albert_config.json',
    "The config json file corresponding to the pre-trained BERT model. "
    "This specifies the model architecture.")

flags.DEFINE_string("task_name", 'SKE_2019', "The name of the task to train.")

flags.DEFINE_string("vocab_file", 'pretrained_model/chinese_L-12_H-768_A-12/vocab_chinese.txt',
